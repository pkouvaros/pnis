...
class MultiAgent:
    ...
    # Nice to have, but in practice we need to encode constraints for a joint protocol for all agents in Agt.
    # @abstractmethod
    # def get_constraints_for_protocol(self, constrs_manager, input_state_vars, idx, binvars):
    #     """
    #     Get the constraints for the protocol function.
    #     :param constrs_manager: Constraint manager handling all constraints.
    #     :param input_state_vars: Set of variables representing the state that
    #     is input to the agent's protocol function.
    #     :param idx: Encode just one transition.
    #     :param binvars: Unused.
    #     :side-effects: May modify constrs_manager.
    #     :return:
    #         A set of actions,
    #         the constraints and
