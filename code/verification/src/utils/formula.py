...
from src.utils.formula_interface import Formula
...
class GammaExistentialFormula(UnaryFormula):
    """
    Represents formulas of the form  << Gamma >>^k phi
    """

    def __init__(self, k, gamma, not_gamma, left):
        super(GammaExistentialFormula, self).__init__(left)
        self.k = k
        self.gamma = gamma
    ...
    def __str__(self):
        return "<< {} >> {} ({})".format(', '.join(map(str, self.gamma)), self.k, str(self.left))

    def accept(self, visitor):
        visitor.visitGammaExistentialFormula(self)

    def acceptI(self, visitor):
        return visitor.visitGammaExistentialFormula(self)


class GammaUniversalFormula(UnaryFormula):
    """
    Represents formulas of the form  << Gamma >>^k phi
    """

    def __init__(self, k, gamma, not_gamma, left):
        super(GammaUniversalFormula, self).__init__(left)
        self.k = k
        self.gamma = gamma
        self.not_gamma = not_gamma
        self.name = "[[Gamma]] X"
    ...
    def accept(self, visitor):
        visitor.visitGammaUniversalFormula(self)

    def acceptI(self, visitor):
        return visitor.visitGammaUniversalFormula(self)
