...
\newcommand{\inite}[0]{I_e}
\newcommand{\plstate}[1]{l'_{#1}}
\newcommand{\pplstate}[1]{l''_{#1}}
\newcommand{\prvs}[1]{\mathit{Prv}_{#1}}
\newcommand{\pers}[1]{\mathit{Per}_{#1}}
\newcommand{\prv}[1]{\mathit{prv}_{#1}}
\newcommand{\per}[1]{\mathit{per}_{#1}}
\newcommand{\pprv}[1]{\mathit{prv}'_{#1}}
\newcommand{\pper}[1]{\mathit{per}'_{#1}}
\newcommand{\prot}[1]{\mathit{prot}_{#1}}
\newcommand{\obs}[1]{\mathit{obs}_{#1}}
\newcommand{\tr}[1]{\mathit{tr}_{#1}}
