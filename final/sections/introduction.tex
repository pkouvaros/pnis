...
verification in the unbounded\nb{E: we use bounded/ unbounded in two different ways. One to refer to the temporal bound. The other to refer to the bounded number of agents. Maybe we should rephrase it to avoid confusion} case can be reduced to the
