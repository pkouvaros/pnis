...
\newcommand{\aglobalstates}[1]{G^{(#1)}_{zo}}
\newcommand{\aglobaltr}[1]{\it{tr}^{(#1)}_{zo}}
\newcommand{\aglobalrel}[1]{T^{(#1)}_{zo}}
\newcommand{\aglobalinit}[1]{\iota^{({#1})}_{zo}}
\newcommand{\avaluation}[1]{\ell^{(#1)}_{zo}}
\newcommand{\tlabel}[1]{\ell_{#1}}
\newcommand{\prop}[0]{\it{AP}}
\newcommand{\ctl}[0]{\sf{CTL}}
\newcommand{\bctl}[0]{\sf{bCTL}}
\newcommand{\bictl}[0]{\sf{bIACTL}}
