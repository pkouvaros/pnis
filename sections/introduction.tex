...
irrespective of the number of participants such as robot swarms and scenarios
...
with the real-valued operational domain of the neural network models, the
...
dilemma scenario devised to emulate a \emph{collective risk dilemma (CRD)}, a type of
