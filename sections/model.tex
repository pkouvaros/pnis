...
\emph{local action} of agent $\ag i$ in~$\alpha$.  The set
...
actions.   We now formally define the concrete NIS.
...
A path in a model $\msys n$ is an infinite sequence of global states and joint
...
system that the formula in question is evaluated; and (ii) permits only the
...
verification for unbounded formulae~\cite{Akintunde+20}.
