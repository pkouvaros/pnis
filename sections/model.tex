...
\begin{example}
  ...
  neighbouring cells. The penguin radiates some heat in each of the 6
  directions where there are no neighbours, while for each direction where
  there is a neighbour the penguin gains/preserves some heat.
  ...
  \begin{center}
    \begin{tikzpicture}[%
      hexagon/.style={draw=gray,  regular polygon, regular polygon
        sides=6, minimum height=\d{}mm, rotate=30}]
