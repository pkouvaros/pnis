...
private states, its associated zero-one agent is a tuple $\ag{zo} =
...
\begin{itemize} 
    ...
    be collectively generate in a global state represented by the abstract
...
satisfaction of the formula. The Theorem can be proved by inductively
